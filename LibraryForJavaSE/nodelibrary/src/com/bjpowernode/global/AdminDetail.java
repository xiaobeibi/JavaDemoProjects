package com.bjpowernode.global;
...
public class AdminDetail extends GNControl {
    ...
    public AdminDetail(String name, String text, String subtitle) {
        super(text, subtitle);
    ...
    @Override
    public Node icon() {
        Image image = new Image(getClass().getResource("/com/bjpowernode/media/img/avatar.png").toExternalForm());
...
//        System.out.println(getName());
        ...
        gnAvatar.setImage(new Image(getClass().getResource("/com/bjpowernode/media/img/avatar.png").toExternalForm()));
        ...
        popOver.getRoot().getStylesheets().add(getClass().getResource("/com/bjpowernode/theme/css/poplight.css").toExternalForm());
